                ...
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav mr-auto">
                        {!!userData && 
                            ...
                            <NavLink to={`/profile/${userData.user.id}?username=${userData.user.username}&pub_id=${userData.user.publisher_id}`} className="nav-link"><strong>{userData.user.username}</strong></NavLink>
                            </li>
                        }
                        <li className="nav-item">
